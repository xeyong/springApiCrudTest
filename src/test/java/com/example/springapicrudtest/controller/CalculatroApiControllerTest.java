...
import com.example.springapicrudtest.component.DollorCalculator;
import com.example.springapicrudtest.component.MarketApi;
...
public class CalculatroApiControllerTest {
    @MockBean
    private MarketApi marketApi;

    @Autowired
    private MockMvc mockMvc;//Mvc를 mocking으로 테스트함
